...
public class ImportsResolver {
    ...
    private void processImports(LookupMode lookupMode, @NotNull JetScope rootScope) {
    ...
    private void processImportsInFile(LookupMode lookupMode, WritableScope scope, List<JetImportDirective> directives, JetScope rootScope) {
