    ...
    private static class TypeOrExpressionThereof {
        ...
        public String[] getPossibleNamesFromExpression() {
            ...
            cachedNameCandidatesFromExpression = isType()
                                                 ...
                                                 : JetNameSuggester.suggestNamesForExpression(expressionOfType, new DummyJetNameValidator(
                                                         expressionOfType.getProject()));
        ...
        public LookupElement[] calculateLookupItems(ExpressionContext context) {
            ...
            if (parameter != null) {
                ...
                if (selectedType != null) { // user selected a type we suggested
                    Collections.addAll(names, JetNameSuggester.suggestNamesForType(selectedType, new DummyJetNameValidator(project)));
                    ...
                    if (enteredType != null) {
                        Collections.addAll(names, JetNameSuggester.suggestNamesForType(enteredType, new DummyJetNameValidator(project)));
                    }
                }
            }
